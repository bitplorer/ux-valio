...
pip install ux-valio[native]         # optional Integer/Float/String/Bytes/IntegerEnum/StringEnum/Boolean/Decimal/Date/DateTime apply peer
```
...
`DecimalValidator()` (exact `decimal.Decimal`; no float bridge, no scale unit) /
