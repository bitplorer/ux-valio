...
from ux_valio.validators.bounds import bound, reject_exclusive, reject_inverted, specified
...
class MinValueValidator(ValidateProperty):
    ...
    def _validate_min_value(self, instance: Any, value: Any) -> None:
        if value is None:
            return
        min_value = bound(self, "min_value")
        gt = bound(self, "gt")
...
class MaxValueValidator(ValidateProperty):
    ...
    def _validate_max_value(self, instance: Any, value: Any) -> None:
        if value is None:
            return
        max_value = bound(self, "max_value")
        lt = bound(self, "lt")
