...
"""Compose-root pre_validate hang; leaf stacks stay bag-free; merge fail-closed."""
...
def test_nested_compose_with_hooks_is_not_flattened():
    ...
    inner.pre_validate(lambda instance, value: value, namespace="compose.User")
...
def test_anyof_root_also_has_add_star():
    ...
    assert hasattr(field, "post_validate")
