...
"""Optional ``ux-valio[native]`` peer: Integer/Float bounds, String/Bytes length, IntegerEnum members.
...
def test_integer_enum_unclosed_and_other_facades_stay_on_host():
    ...
    string_enum = _bind_enum_field(_Shade, cls=StringEnumValidator)
    ...
    assert boolean._native_plan is None
